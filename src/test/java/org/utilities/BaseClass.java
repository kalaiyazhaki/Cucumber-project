...
public static void screenshot(String name) throws IOException {
	...
	File des=new File("C:\\Users\\Admin\\eclipse-workspacekalai\\FrameworkCucumber\\target\\Screenshots\\"+name+".jpg");
	FileUtils.copyFile(src, des);
	
}

// screenshot in JVMReport
public static void screenshotReport(String s) {
...
//55.text to be present in element
public static void txtToPre(By locate) {
w=new WebDriverWait(driver,10);
w.until(ExpectedConditions.elementToBeClickable(locate)).click();;
}
...
public static String getData(int rowNumber,int cellNumber) throws IOException {
	//Declare the location of ur excel sheet
			File f=new File("C:\\Users\\Admin\\eclipse-workspacekalai\\FrameworkCucumber\\target\\testData\\Excel data 1.xlsx");
